...
## 3. Registration
<details>
  <summary>Register for <b>Qulab_EMA</b> by using the email address you got from us, creating a password, and completing your profile setup. <b>Please make sure the 3 digit number is correct!</b> <b>(Click for more infomation)<b/></summary>
    <div style="display: flex; justify-content: space-between;">
